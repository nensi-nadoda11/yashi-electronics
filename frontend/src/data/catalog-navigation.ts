...
export const getCatalogCategoryLabel = (slug?: string | null) => {
  if (!slug) {
    return 'All'
  }
...
export const getCatalogMainCategoryForSlug = (slug?: string | null) => {
  if (!slug) {
    return undefined
  }
...
export const getCatalogCategoryFilterSlugs = (slug: string) => {
